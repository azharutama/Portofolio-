<x-dashboard.layout>
  ...
  <main class="p-4 md:ml-64 h-full pt-20">
      ...
      <div class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 h-full w-full p-4 ">
        <table class="w-full border-collapse border border-gray-300 dark:border-gray-600">
          ...
          <tbody>
            ...
            <tr>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 3 Col 1</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 3 Col 2</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 3 Col 3</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 3 Col 4</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 3 Col 5</td>
            </tr>
            <tr>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 4 Col 1</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 4 Col 2</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 4 Col 3</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 4 Col 4</td>
              <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Row 4 Col 5</td>
            </tr>
          </tbody>
        </table>
      </div>
