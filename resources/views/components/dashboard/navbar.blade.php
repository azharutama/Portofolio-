<nav class="bg-gradient-to-br from-[#000000] via-[#070335] to-[#04041c] border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
  ...
  <aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-gradient-to-br from-[#000000] via-[#070335] to-[#04041c] ">
